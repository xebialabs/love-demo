...
python -m yay dashboards/add_dashboard.yay folder="Cool Store/Shopping cart" file=dashboards/shopping_cart_dashboard.yaml
python -m yay dashboards/add_dashboard.yay folder="Cool Store/Wish list" file=dashboards/wish_list_dashboard.yaml
